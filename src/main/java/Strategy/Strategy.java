...
public class Strategy implements IStrategy {
    protected final int SUPRESSORS_COUNT = 100;
    protected final int BREAK_PLATES_COUNT = 200;
    protected final int HEADLIGHTS_COUNT = 150;

    protected final double SUPPRESSORS_STOCK_PRICE = 0.2;
