...
public class CustomStrategy extends Strategy {
    ...
    private boolean supplier1Allowed;
    private boolean supplier2Allowed;
    ...
    public void setSupplier1Allowed(boolean supplier1Allowed) {
        this.supplier1Allowed = supplier1Allowed;
    }

    public void setSupplier2Allowed(boolean supplier2Allowed) {
        this.supplier2Allowed = supplier2Allowed;
    }
}
